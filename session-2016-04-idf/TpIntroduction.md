# [TP : Introduction](README.md "wikilink") \[\#license ©\]
...
Pour amorcer le TP : comprenez, compilez et éxécutez le fichier [tp0\_code\_initial.cpp](coefs-old/tp0_code_initial.cpp "wikilink"), comprenant de petites fonctions utiles pour la suite. Si vous travaillez sous linux, vous pouvez utiliser le script [tp0\_code\_initial.sh](coefs-old/tp0_code_initial.sh "wikilink") pour enchainer compilation et éxécution.
